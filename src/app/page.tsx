        ...
        <div className="max-w-4xl mx-auto text-center">
          <AnimatedSection>
            ...
            <p className="body-large text-[var(--text-secondary)] max-w-2xl mx-auto">
              ...
              accessibile. Non memorizzate sintassi: descrivete cosa volete.
            </p>
          </AnimatedSection>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            <div className="quote-block">
              ...
              saper descrivere cosa volete, e l&apos;AI scrive le formule per voi. Questo modulo
              vi insegna a generare formule in linguaggio naturale, pulire dati sporchi,
              analizzare dataset, creare visualizzazioni efficaci, e digitalizzare documenti cartacei.
            </div>
          </AnimatedSection>
        </div>
      </section>
          ...
          <AnimatedSection>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                { n: '2', text: 'Garbage in, garbage out — Pulite sempre i dati prima di analizzarli' },
                { n: '3', text: 'Code Interpreter esegue davvero — Non e chat: fa calcoli reali e genera file' },
                ...
                { n: '6', text: 'Il grafico giusto racconta una storia — Prima il messaggio, poi il tipo di grafico' },
                { n: '7', text: 'Verificate sempre — L\'AI e un assistente, non un oracolo infallibile' },
                { n: '8', text: 'Form > Excel condiviso — Per raccogliere dati, usate sempre un form' },
              ].map((item) => (
          ...
          <AnimatedSection>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="glass-card p-5">
                <h4 className="font-semibold mb-3 text-[var(--accent-primary)]">Guide ufficiali</h4>
